...
public static class SkyboxVisualizer
{
    ...
    private static class ColorModulator
    {
        public static Color Modulate(Color baseColor, float red, float green, float blue, float intensity, float baseColorPart = 0.5f)
        {
            ...
            float beatBoost = VisualizerConfig.ColorIntensity.Value;
            ...
            s *= VisualizerConfig.ColorSaturation.Value;
    ...
    static void PostfixUpdate(Skybox __instance)
    {
        ...
        if (!VisualizerConfig.EnableVisualizer.Value)
        {
            if (wasEnabled)
            {
        ...
        // Skip processing every other frame on low quality
        if (VisualizerConfig.QualityLevel.Value < 2 && Time.frameCount % 2 == 0) return;
        ...
        float intensity = VisualizerConfig.Intensity.Value;
        ...
        // ========================
        float subBassBeatStrength = audioProcessor.bandDetectors[0].beatStrength * VisualizerConfig.BeatResponse.Value;
        float mainBassBeatStrength = audioProcessor.bandDetectors[1].beatStrength * VisualizerConfig.BeatResponse.Value;
        float upperBassBeatStrength = audioProcessor.bandDetectors[2].beatStrength * VisualizerConfig.BeatResponse.Value;
        float lowMidsBeatStrength = audioProcessor.bandDetectors[3].beatStrength * VisualizerConfig.BeatResponse.Value;
        float midBeatStrength = audioProcessor.bandDetectors[4].beatStrength * VisualizerConfig.BeatResponse.Value;
        float highMidBeatStrength = audioProcessor.bandDetectors[5].beatStrength * VisualizerConfig.BeatResponse.Value;
        float presenceLowBeatStrength = audioProcessor.bandDetectors[6].beatStrength * VisualizerConfig.BeatResponse.Value;
        float presenceHighBeatStrength = audioProcessor.bandDetectors[7].beatStrength * VisualizerConfig.BeatResponse.Value;
        float airBeatStrength = audioProcessor.bandDetectors[8].beatStrength * VisualizerConfig.BeatResponse.Value;
        float generalBeatStrength = audioProcessor.generalBeat.beatStrength * VisualizerConfig.BeatResponse.Value;
        ...
        if (VisualizerConfig.AffectLighting.Value && sunLight != null)
        {
            ...
            Color finalColor = Color.HSVToRGB(hFinal, sFinal, vFinal, true) * VisualizerConfig.LightColorMultiplier.Value;
            ...
            float ceiling = initialSunIntensity * VisualizerConfig.LightIntensityMultiplier.Value * 1.9f;
            float limitedIntensity = SoftLimit(targetIntensity * VisualizerConfig.LightIntensityMultiplier.Value, ceiling, 0.65f);

            float outSmooth = Mathf.Lerp(1f, 25f, audioProcessor.generalBeat.averageEnergy * 1.3f);
            outSmooth *= VisualizerConfig.LightColorLerpSpeed.Value;
            ...
            // Sun angle behavior 
            string preset = VisualizerConfig.SunAnglePreset?.Value ?? "Disable";
            ...
            if (preset == "TrackLength")
            {
                ...
                {
                    sunAngleCurrent = Mathf.Lerp(sunAngleCurrent, sunAngleTarget, Time.deltaTime * 0.25f * VisualizerConfig.SunAngleLerpSpeedMultiplier.Value);
            ...
            if (VisualizerConfig.AffectAmbient.Value)
            {
                ...
                else
                {
                    ...
                    Color targetAmbientColor = ColorModulator.ApplyDensity(ambientBaseColor + coolBias, (1f - intensityReduction * 2f))
                                               * VisualizerConfig.AmbientColorMultiplier.Value;
                    ...
                    ) * VisualizerConfig.AmbientIntensityMultiplier.Value;
                    ...
                    float lightSpeed = Mathf.Lerp(0.5f, 2.5f, highEnergy) * VisualizerConfig.AmbientColorLerpSpeed.Value;                            // ambient (sky) color
                    float intensitySpeed = Mathf.Lerp(1.0f, 3.0f, totalEnergy) * 2.5f * VisualizerConfig.AmbientColorLerpSpeed.Value;                     // intensity can respond faster
                    float equatorSpeed = Mathf.Lerp(0.75f, 2.25f, Mathf.Clamp01(midEnergy * 0.8f + midEnergy * 0.2f)) * VisualizerConfig.AmbientColorLerpSpeed.Value;
                    float groundSpeed = Mathf.Lerp(0.8f, 2.2f, Mathf.Clamp01(lowEnergy * 0.8f + highEnergy * 0.2f)) * VisualizerConfig.AmbientColorLerpSpeed.Value;
        ...
        //Clouds effects
        if (VisualizerConfig.AffectClouds.Value)
        {
            ...
            // ==========================
            if (VisualizerConfig.CrazyCloudColor.Value)
            {
                ...
                float intensityMultiplier = VisualizerConfig.CrazyCloudColorIntensity.Value;
                ...
                colorSpeed *= VisualizerConfig.CrazyCloudColorLerpSpeed.Value;
            ...
            else
            {
                ...
                float intensityMultiplier = VisualizerConfig.CloudColorIntensity.Value;
                ...
                float colorSpeed = 3f
                                 ...
                                 + 3f * weightedBassBeat;
                colorSpeed *= VisualizerConfig.CloudColorLerpSpeed.Value;
            ...
            float scaleModifier = baseScaleModifier * (1f + Mathf.Max(0f, cloudJumpAmount) * 0.1f * VisualizerConfig.JumpScaleMultiplier.Value);
            ...
            _currentVolumeStrength = Mathf.Lerp(_currentVolumeStrength, _targetVolumeStrength * VisualizerConfig.SkyVolumeStrength.Value,
            ...
            // Wind 
            // ==========================================
            float windTarget1 = initialWind1 * VisualizerConfig.CloudWindBeatScale.Value * lowEnergy * 2f;
            float windTarget2 = initialWind2 * VisualizerConfig.CloudWindBeatScale.Value * highEnergy * 2f;
        ...
        ///////////
        //Horizon//
        if (VisualizerConfig.AffectHorizon.Value)
        {
            ...
            float horizonColorLerpSpeed = baseLerpSpeed * VisualizerConfig.HorizonColorLerpSpeed.Value;
            ...
            targetColor.r = ((targetColor.r * 1.5f) - 0.50f) * VisualizerConfig.HorizonColorIntensity.Value;
            targetColor.g = ((targetColor.g * 1.5f) - 0.50f) * VisualizerConfig.HorizonColorIntensity.Value;
            targetColor.b = ((targetColor.b * 1.5f) - 0.50f) * VisualizerConfig.HorizonColorIntensity.Value;
            targetColor = ColorModulator.ApplyDensity(targetColor, maxHighBeatStrength * 1.2f);
            targetColor.a = ((targetColor.a * 0.8f) - 0.4f) * VisualizerConfig.HorizonColorDensity.Value;
        ...
        // Star pulse
        if (VisualizerConfig.AffectStars.Value)
        {
    ...
    public static void CaptureSceneSettings(string sceneName)
    {
        ...
        var sky = Object.FindObjectOfType<Skybox>();
    ...
    private static void InitializeForScene(Scene scene)
    {
        ...
        var skyNow = Object.FindObjectOfType<Skybox>();
    ...
    public static void Initialize()
    {
        ...
        if (audioProcessor == null)
        {
            ...
            GameObject processorObj = new GameObject("AudioSpectrumProcessor");
